...
void myfunction10() {
    ...
    // myfunction10_not1:değişkenler bu şekilde yazıldığında IDE(Visual Studio) değişkenin tür değişimini daha çok önemser.
    // Eðer ki bu satır(not1 satırı) açılırsa (comment çizgileri silinip satır çalışır hale gelirse)...
...
void myfunction11() {
    ...
    //////////////////////////////////////////////
    //bu fonksiyonda değişkenlerin türünü static_cast<>() kullanarak manuel olarak deðiştiriyoruz.
    int a{ 2 };
    float b{ 3.5 };
    char c{ 65 };
    char d{ 'B' };
...
void myfunction12() {  //fonksiyonlarda void ön eki fonskiyonun bir şey çıkarmayacağını haber verir. Yani "return a;" vs yok.
    ...
    // 
    // myfunction12_not2: Bir değişkenin ram'de bulunduðu adres hex biçimi ile gösterilir.
    ...
    // Pointer değişkenin tutulduðu adresi gösterir.
    // 
    ...
    // 
    // myfunction12_not5:Bir deðişkenin ram adresini bulduğumuz gibi pointerlerin de ram adresini aynı şekilde(soluna & koyarak) bulabiliriz.
    // 
    //////////////////////////////////////////////
