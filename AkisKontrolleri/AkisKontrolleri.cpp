...
void while_function3() {
    ...
    while (islem2 == 'e' || islem2 == 'E') {
        ...
        if (islem == 'z' || islem == 'Z') { continue; } //continue komutu döngüyü anýnda baþa döndürür
...
void while_function4() {
    ...
    while (islem2 == 'e' || islem2 == 'E') {
        ...
        if (islem == 'z' || islem == 'Z') { continue; } //continue komutu döngüyü anýnda baþa döndürür
        else if (islem == 'e' || islem == 'E') { goto cikis2; } //goto komutu ile döngünün tamamý geçilebilir
        else if (islem == 'p' || islem == 'P') { goto cikis1; } //goto komutu ile döngüdeki bazý satýrlar atlanabilir
...
void do_while_function() {
    int a; //do while komutunda ilk önce kod çalýþýr sonra þart kontrol edilir. Böylece þart yanlýþ bile olsa en az 1 kere çalýþýr.
    do
    {
